...
let exampleTrailer1 = Trailer( name: "Season 3 Trailer", videoURL: exampleVideoURL, thubnailImageURL: exampleImageURL)
let exampleTrailer2 = Trailer( name: "The Hero's Journey", videoURL: exampleVideoURL, thubnailImageURL: exampleImageURL2)
let exampleTrailer3 = Trailer( name: "The Mysterious", videoURL: exampleVideoURL, thubnailImageURL: exampleImageURL1)
...
let exampleMovie1 = Movie(
    id: UUID().uuidString,
    name: "DARK",
    thubnailURL: URL(string: "https://picsum.photos/200/300")!,
    categories: ["Dystopian", "Exciting", "Successful", "Sci-Fi TV"],
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 3,
...
let exampleMovie3 = Movie(
    id: UUID().uuidString,
    name: "Community",
    thubnailURL: URL(string: "https://picsum.photos/200/301")!,
    categories: ["Dystopian", "Exciting", "Successful", "Sci-Fi TV"],
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 3,
...
let exampleMovie4 = Movie(
    id: UUID().uuidString,
    name: "Alone",
    thubnailURL: URL(string: "https://picsum.photos/200/302")!,
    categories: ["Dystopian", "Exciting", "Successful", "Sci-Fi TV"],
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 4,
...
let exampleMovie5 = Movie(
    id: UUID().uuidString,
    name: "Hanibal",
    thubnailURL: URL(string: "https://picsum.photos/200/303")!,
    categories: ["Dystopian", "Exciting", "Successful", "Sci-Fi TV"],
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 5,
...
let exampleMovie6 = Movie(
    id: UUID().uuidString,
    name: "After Life",
    thubnailURL: URL(string: "https://picsum.photos/200/304")!,
    categories: ["Dystopian", "Exciting", "Successful", "Sci-Fi TV"],
    year: 2020,
    rating: "TV-MA",
    numberOfSeasons: 6,
...
let exampleEpisode1 = CurrentEpisodeInfo(episodeName: "Beginning and Endings", description: "Six months after the disappearances, the police form a task force. In 2052, Jonas learns that most of Winden perished in an apocalyptic event.", season: 2, episode: 1)
